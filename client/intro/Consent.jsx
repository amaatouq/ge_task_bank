        ...
        <Wrapper {...this.props}>
          <div className="flex justify-center items-center text-base text-gray-800">
            <div className="max-w-2xl">
              ...
              <p>The approximate duration of this study is <strong>{time} minutes</strong>.</p>
              ...
              <p>
                In this study, we will ask you to answer some questions. You will earn ${pay} guaranteed pay for each question answered, and you will earn a bonus payment of $0-${bonus} per question based on how accurately you answered. The more accurate your answer, the higher your bonus payment.
              </p>
